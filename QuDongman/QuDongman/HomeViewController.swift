...
//        tableview?.reloadData()
        ...
        HttpUnit.HttpGet(url: NSString.home() ) { (response, status) in
            if status {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = JYHomeCell.createCell(tableview: tableView, info: dataInfo as! NSDictionary, indexPath: indexPath as NSIndexPath)
        return cell
    }
